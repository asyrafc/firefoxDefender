...
if(window.location.href.indexOf("%22") > -1 || window.location.href.indexOf("1=1") > -1 )
{
	alert(window.location.href);
	//this line will render the html code in the website useless as everything will be commented out
	/*var newWindow = window.open();
	...
	var scriptStr = window.location.href.substring(window.location.href.lastIndexOf("%22"));
	alert(decodeURIComponent(scriptStr));
	//document.body.innerHTML = '<!--';
	//document.write('<!--');
	//document.write('-->');
	...
	document.body.innerHTML = "<h1>Warning</h1>"
		+ "<p>Page loading have been intercepted as the website that you visited just now might contain malicious content</p> "
		+ "<p>Type Of Attack : SQL Injection</p> "
		+ scriptStr;
